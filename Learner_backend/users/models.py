...
from .mail_utils import Util
from .mail_utils import email_messages
#  Custom User Manager
...
def send_email_on_contact_save(sender, instance, **kwargs):
    email = instance.email
    name = instance.name
    html_content = render_to_string('Mail.html', {'name': name})
    data = {
        'subject': 'Welcom to Learner',
        'body': html_content,
        'to_email': email,
